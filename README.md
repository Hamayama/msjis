...
4. (以下の記述は、Windows 8.1 (64bit), Gauche v0.9.5 でのみ動作確認しています)  
   ...
   Gauche v0.9.4 以前では表示できません。Gauche v0.9.5 では表示できます。  
   ...
   (備考) 絵文字 (#\u1F363 の「すし」等) については、Gauche v0.9.5 であれば表示できますが、  
   カーソル位置がずれます。上記設定で Monospace にチェックを入れて Cell 幅を 16 等に  
   設定すれば、ずれなくできます (ただし見づらい) 。
